...
// This wrapper bundles the englishbreakfast power domain wrapper together with the
...
module top_englishbreakfast_verilator #(
  ...
  englishbreakfast_pd_main #(
    ...
    .usbdev_usb_tx_d_o        (usb_tx_d_o         ),
    .usbdev_usb_tx_se0_o      (usb_tx_se0_o       ),
    .usbdev_usb_tx_use_d_se0_o(usb_tx_use_d_se0_o ),
