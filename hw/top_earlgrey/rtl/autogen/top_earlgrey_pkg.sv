...
package top_earlgrey_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertIdRstmgrFatalSecTest = 24,
    TopEarlgreyAlertIdClkmgrRecovFault = 25,
    TopEarlgreyAlertIdClkmgrFatalFault = 26,
    TopEarlgreyAlertIdSysrstCtrlFatalFault = 27,
    TopEarlgreyAlertIdAdcCtrlFatalFault = 28,
    TopEarlgreyAlertIdPinmuxFatalFault = 29,
    TopEarlgreyAlertIdAonTimerFatalFault = 30,
    TopEarlgreyAlertIdSensorCtrlRecovAlert = 31,
    TopEarlgreyAlertIdSensorCtrlFatalAlert = 32,
    TopEarlgreyAlertIdSramCtrlRetFatalError = 33,
    TopEarlgreyAlertIdRramCtrlRecovErr = 34,
    TopEarlgreyAlertIdRramCtrlFatalStdErr = 35,
    TopEarlgreyAlertIdRramCtrlFatalErr = 36,
    TopEarlgreyAlertIdRramCtrlFatalMacroErr = 37,
    TopEarlgreyAlertIdRramCtrlRecovMacroErr = 38,
    ...
    TopEarlgreyAlertIdKeymgrDpeRecovOperationErr = 48,
    TopEarlgreyAlertIdKeymgrDpeFatalFaultErr = 49,
    ...
    TopEarlgreyAlertIdSramCtrlSecFatalError = 59,
    ...
    TopEarlgreyAlertIdCheriotFatalFault = 65,
    TopEarlgreyAlertIdSramCtrlMetaFatalError = 66,
