...
`ifndef GATE_LEVEL
    ...
    $asserton(1, earlgrey_pd_aon.u_pwrmgr_aon.u_slow_fsm.IntRstReq_A);
`endif
  endtask
...
`ifndef GATE_LEVEL
    ...
    if (!value) begin
      ...
      $assertoff(1, earlgrey_pd_aon.u_pwrmgr_aon.u_slow_fsm.IntRstReq_A);
    end
...
`undef GLITCH_VCMAIN_POK
  ...
  task static force_key0_i(bit value);
    ...
    force earlgrey_pd_main.mio_in_i[MioInSysrstCtrlAonKey0In] = value;
  endtask
