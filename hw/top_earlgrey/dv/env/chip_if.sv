...
`define PATTGEN_HIER        `PD_MAIN_HIER.u_pattgen
`define PINMUX_HIER         `PD_MAIN_HIER.u_pinmux_aon
`define PWM_HIER            `PD_AON_HIER.u_pwm_aon
...
`endif
  ...
  // tb.dut.top_earlgrey.earlgrey_pd_aon.u_pwm_aon.u_pwm_core.cntr_en
