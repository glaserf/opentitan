...
<%include file="/chiplevel_snippets/padring.tpl" args="target=target, pinmux=pinmux, dedicated_pads=dedicated_pads, muxed_pads=muxed_pads, get_dio_sig=get_dio_sig" />\
