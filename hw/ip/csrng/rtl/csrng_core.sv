...
module csrng_core import csrng_pkg::*; #(
  ...
  logic [CntrLen-1:0]          state_db_wr_rc;
  ...
  logic [CntrLen-1:0]          gen_result_rc;
  ...
  logic [CntrLen-1:0]          state_db_rd_rc;
 ...
 // set the err code type bits
  ...
  assign state_db_wr_rc      = gen_blk_select ? gen_result_rc      : ctr_drbg_cmd_rsp_data.rc_cnt;
  ...
  csrng_upd_data_flat_t upd_arb_dout_flat;
  ...
  assign upd_arb_dout = csrng_upd_data_t'(upd_arb_dout_flat);
  ...
  csrng_ctr_drbg_gen u_csrng_ctr_drbg_gen (
    ...
    .ctr_drbg_gen_rc_i(ctr_drbg_cmd_rsp_data.rc_cnt),
...
`ifdef INC_ASSERT
  ...
  `ASSERT_INIT(CsrngNumAppsMatch_A, NumApps == NumHwApps+1)
`endif
