...
class chip_sw_pwrmgr_deep_sleep_all_wake_ups_vseq extends chip_sw_base_vseq;
  ...
  localparam string ADC_CHANNEL_OUT_HDL_PATH = "tb.dut.top_darjeeling.u_ast.adc_d_o[9:0]";
  localparam string ADC_CHANNEL_IN_SEL_HDL_PATH = "tb.dut.top_darjeeling.u_ast.adc_chnsel_i[1:0]";
