...
class chip_sw_sensor_ctrl_status_intr_vseq extends chip_sw_base_vseq;
  ...
  `else
    localparam string VIOA_POK_PATH = "tb.dut.top_darjeeling.u_ast.ast_pwst_o.io_pok[0]";
    localparam string VIOB_POK_PATH = "tb.dut.top_darjeeling.u_ast.ast_pwst_o.io_pok[1]";
  `endif
